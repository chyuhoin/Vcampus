...
public class TabbedPanelCourse_A extends JTabbedPane {
    ...
    public TabbedPanelCourse_A(int flag)
    {
        ...
        if(flag==3) {
            ...
            JPanel jp5=new PanelAutoScheduling_A();


            this.addTab("创建课程", new ImageIcon("Vcampus//resource//tab_add.png"), createCourse, "创建课程");
            this.addTab("删除课程", new ImageIcon("Vcampus//resource//tab_delete.png"), deleteCourse, "删除课程");
            ...
            this.addTab("自动排课", new ImageIcon("Vcampus//resource//btn_lesson.png"),jp5, "自动排课");
