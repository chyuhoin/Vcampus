...
import com.vcampus.client.window.setjpLibrary.mytablepanel.MyTable;
...
public class MyTablePanel_Course extends JPanel{
    ...
    com.vcampus.client.window.setjpLibrary.mytablepanel.MyTable table=null;//表格
    ...
    public MyTablePanel_Course(Object[][] rowData, Object[] columnNames){
        //卡片
        PANEL=this;
